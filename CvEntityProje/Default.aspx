...
<body>
    <div class="sidenav text-center">
		<div class="side_top">
			...
			<h1 class="top_hd mt-2"><a href="index.html">Furkan Güven</a></h1>
...
<section class="slide-wrapper" id="about">
    ...
    <p class="iner mt-md-5"> <asp:Repeater ID="Repeater2" runat="server">
			<ItemTemplate>
				<%#Eval("EGITIM") %>
            </ItemTemplate>
        </asp:Repeater>
...
<section class="services" id="services">
	<div class="container">
       ...
       <div class="news" id="news">
		...
		<p class="iner mt-md-5 text-left"> <asp:Repeater ID="Repeater3" runat="server">
			<ItemTemplate>
				<%#Eval("ISDENEYIMLERI") %>
            </ItemTemplate>
        </asp:Repeater> </p>
	...
	<h3 class="w3_head mb-4 text-left"> İletişim</h3>
		<div class="contact_grid_right mt-5 mx-auto text-left">
				<form action="#" method="post" runat="server">
					...
					<asp:TextBox ID="TextBox4" runat="server" placeholder="Mesajınızı Yazın" TextMode="MultiLine" Height="50"></asp:TextBox>
					<asp:Button ID="Button1" CssClass="btn btn-info" runat="server" Text="Gönder" OnClick="Button1_Click" />
                    <asp:Button ID="Button2" CssClass="btn btn-warning" runat="server" Text="Vazgeç" />
